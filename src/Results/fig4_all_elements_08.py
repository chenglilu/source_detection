...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 14:25:54 2021

@author: lilucheng
"""
#we plot all elemnts into three samle fig based on the source lithology
#try to the right and wrong prediction for each type of source  for each elemnts
...
plt1.legend(['Mafic R', 'Mafic W'], loc='upper right',fontsize=6)
...
#plt.xticks([])
#plt.figtext(0.28,0.9,'(a)',color='black',fontsize=12)
plt2.legend(['Transitional R', 'Transitional W'], loc='upper right',fontsize=6)
...
#plt.xticks([])
#plt.figtext(0.28,0.9,'(a)',color='black',fontsize=12)
plt3.legend(['Peridotitic R', 'TPeridotitic W'], loc='upper right',fontsize=6)
