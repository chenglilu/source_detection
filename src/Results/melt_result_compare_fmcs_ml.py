...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 14:25:58 2021

@author: lilucheng
"""

#compare experimental data with fc3ms and fcms to ML
#2021-3-8
...
plt.legend([l1,l2,l3,l4,l5,l6],['Mafic R', 'Transitional R', 'Peridotite R','Mafic W','Transitional W','Peridotite W'], loc='lower left',fontsize=4)
...
plt.savefig('melt_result_compare_fackantms_fcms',dpi=300)
