...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 18 20:37:47 2021
...
plt.legend(['Mafic', 'Transitional', 'Peridotite'], loc='top right',fontsize=7.5)
...
plt.scatter(mgo[idx2r0],fc3ms[idx2r0],marker='s',c='',edgecolors='k',s=30,linewidth=0.5)
plt.scatter(mgo[idx1r0],fc3ms[idx1r0],marker='x',c='deepskyblue',edgecolors='deepskyblue',s=30,linewidth=0.5)

plt.scatter(mgo[idx3r0],fc3ms[idx3r0],marker='^',c='',edgecolors='0.5',s=30,linewidth=0.5)


#plt.scatter(mgo[idx3w0],fc3ms[idx3w0],marker='^',c='',edgecolors='orangered',s=30,linewidth=0.8)
#plt.scatter(mgo[idx2w0],fc3ms[idx2w0],marker='s',edgecolors='orangered',facecolor='gold',s=30,linewidth=0.8)
#plt.scatter(mgo[idx1w0],fc3ms[idx1w0],marker='x',c='orangered',s=30,linewidth=0.8)
...
#----save fig
plt.savefig('only_show_caomgo_fc3ms_checkdata',dpi=300)
