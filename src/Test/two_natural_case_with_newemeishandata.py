...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 13:49:55 2021
...
plt.savefig('Mauna_result_without_compare_check',dpi=300)
...
#result compare
#result compare
Previousemeishan=np.zeros((1240,1)) 
for i in range(0,1240):   
   Previousemeishan[i] = data_emeishan.iloc[i+1,16]  

difference_total=np.zeros((1240,1))
...
plt.xlabel('$\mathregular{Na_2}$O+$\mathregular{K_2}$O(%)(wt%)',fontsize=12)          
...
plt.savefig('emeishan_result_without_campare_check_newdata',dpi=300)
