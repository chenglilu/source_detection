...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 12 14:48:18 2021
...
MSE_ML = mean_squared_error(y_result, y)
...
idxd1=np.where((difference_total!=0) & (Naturedata_result==1)) 
idxd10=idxd1[0]

idxd2=np.where((difference_total!=0) & (Naturedata_result==2)) 
idxd20=idxd2[0]

#idxd3=(np.where(difference_total!=0) and np.where(Naturedata_result==3)) 

idxd3=np.where((difference_total!=0) & (Naturedata_result==3)) 
idxd30=idxd3[0]


#########
idx_part_all=np.where(Previousresult!=2)
idx_part_same=np.where((difference_total==0) & (Previousresult!=2))
Same_rate_part=len(idx_part_same[0])/len(idx_part_all[0])
print('Same number of part the data',Same_rate_part)   
...
l1=plt.scatter(Mg[idx0],fcmsd[idx0],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(Mg[idxd0],fcmsd[idxd0],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)

l2=plt.scatter(Mg[idxd10],fcmsd[idxd10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)

plt.scatter(Mg[idxd20],fcmsd[idxd20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)

plt.scatter(Mg[idxd30],fcmsd[idxd30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
plt.scatter(MgO[idx0],fcmsd[idx0],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(MgO[idxd0],fcmsd[idxd0],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
plt.scatter(MgO[idxd10],fcmsd[idxd10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)

l3=plt.scatter(MgO[idxd20],fcmsd[idxd20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)

l4=plt.scatter(MgO[idxd30],fcmsd[idxd30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
plt.scatter(sica[idx0],fcmsd[idx0],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(sica[idxd0],fcmsd[idxd0],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)

plt.scatter(sica[idxd10],fcmsd[idxd10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)

plt.scatter(sica[idxd20],fcmsd[idxd20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)

plt.scatter(sica[idxd30],fcmsd[idxd30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
l1=plt.scatter(cati[idx0],fcmsd[idx0],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(cati[idxd0],fcmsd[idxd0],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
l2=plt.scatter(cati[idxd10],fcmsd[idxd10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)

l3=plt.scatter(cati[idxd20],fcmsd[idxd20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)

l4=plt.scatter(cati[idxd30],fcmsd[idxd30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)

plt.legend([l1,l2,l3,l4],['Both_M','ANN_P','ANN_T','ANN_M'], loc='lower left',fontsize=7, ncol=1)
...
plt.savefig('Mauna_result',dpi=300)
...
idx_v1_1=np.where((difference_total!=0) & (Emeishandata_result==1)) 
idx_v1_10=idx_v1_1[0]


idx_v1_2=np.where((difference_total!=0) & (Emeishandata_result==2)) 
idx_v1_20=idx_v1_2[0]

idx_v1_3=np.where((difference_total!=0) & (Emeishandata_result==3)) 
...
plt.subplots_adjust(left=0.17, right=0.65,bottom=0.12,top=0.95, wspace=0.4, hspace=0.35)
...
xx=[0,5]
yy2=[0.65,0.65]
plt.plot(xx,yy2,'b--',alpha=0.5)

nak=Na2oe+K2oe

#plt.scatter(nak[idx30],Fc3ms[idx30],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(nak[idx20],Fc3ms[idx20],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)
#plt.scatter(nak[idx10],Fc3ms[idx10],marker='*',c='b',edgecolors='0.5',s=15,linewidth=0.5)
plt.scatter(nak[idx_v10],Fc3ms[idx_v10],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
plt.scatter(nak[idxd_v10],Fc3ms[idxd_v10],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
...
plt.figtext(0.6,0.9,'(a)',color='black',fontsize=12)
...
#plt.scatter(MgOe[idx30],Fc3ms[idx30],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
#plt.scatter(MgOe[idx20],Fc3ms[idx20],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
#plt.scatter(MgOe[idx10],Fc3ms[idx10],marker='*',c='',edgecolors='r',s=15,linewidth=0.5)
plt.scatter(MgOe[idx_v10],Fc3ms[idx_v10],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
plt.scatter(MgOe[idxd_v10],Fc3ms[idxd_v10],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)


plt.legend(['Mafic D', 'Transitional D', 'Peridotite s'], loc='center right',fontsize=8)
...
plt.figtext(0.6,0.42,'(b)',color='black',fontsize=12)
...
yy1=[0.37,0.37]
yy2=[0.05,0.05]
plt.plot(xx,yy1,'b--',alpha=0.5)
plt.plot(xx,yy2,'b--',alpha=0.5)



plt.scatter(nak[idx_v20],Fcms_v2[idx_v20],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
plt.scatter(nak[idxd_v20],Fcms_v2[idxd_v20],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
...
plt.scatter(MgOe[idxd_v20],Fcms_v2[idxd_v20],marker='+',c='r',edgecolors='b',s=15,linewidth=0.5)
...
plt.scatter(nak[idx_v10],Fc3ms[idx_v10],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
plt.scatter(nak[idx_v1_10],Fc3ms[idx_v1_10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)
plt.scatter(nak[idx_v1_20],Fc3ms[idx_v1_20],marker='x',c='g',edgecolors='f',s=15,linewidth=0.5)
plt.scatter(nak[idx_v1_30],Fc3ms[idx_v1_30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
plt.scatter(MgOe[idx_v10],Fc3ms[idx_v10],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
plt.scatter(MgOe[idx_v1_10],Fc3ms[idx_v1_10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)
plt.scatter(MgOe[idx_v1_20],Fc3ms[idx_v1_20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)
plt.scatter(MgOe[idx_v1_30],Fc3ms[idx_v1_30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
l1=plt.scatter(sicae[idx_v20],Fcms_v2[idx_v20],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
l2=plt.scatter(sicae[idx_v2_10],Fcms_v2[idx_v2_10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)
plt.scatter(sicae[idx_v2_20],Fcms_v2[idx_v2_20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)
plt.scatter(sicae[idx_v2_30],Fcms_v2[idx_v2_30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
l1=plt.scatter(catie[idx_v20],Fcms_v2[idx_v20],marker='o',c='',edgecolors='k',s=15,linewidth=0.5)
l2=plt.scatter(catie[idx_v2_10],Fcms_v2[idx_v2_10],marker='+',c='r',edgecolors='r',s=15,linewidth=0.5)
l3=plt.scatter(catie[idx_v2_20],Fcms_v2[idx_v2_20],marker='x',c='g',edgecolors='g',s=15,linewidth=0.5)
l4=plt.scatter(catie[idx_v2_30],Fcms_v2[idx_v2_30],marker='*',c='y',edgecolors='y',s=15,linewidth=0.5)
...
plt.savefig('emeishan_result',dpi=300)