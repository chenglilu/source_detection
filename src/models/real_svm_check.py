...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 13 13:06:27 2021

@author: lilucheng
"""


#this svm for real data  check data
...
print('Accuracy Linear Kernel train:', accuracy_svm_train_lin)
print('Accuracy Polynomial Kernel train:', accuracy_svm_train_poly)
print('Accuracy Radial Basis Kernel train:', accuracy_svm_train_rbf)
print('Accuracy Sigmoid Kernel train:', accuracy_svm_train_sig)
...
plot_confusion_matrix(poly, X, y,normalize='true')  
